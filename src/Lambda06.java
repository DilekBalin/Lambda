...
public class Lambda06 {
    public static void main(String[] args) throws IOException {
        ...
        Files.lines(Paths.get("src/haaluk.txt")).  //Files.lines(Paths.get("")) > texte gel sag klick ve CopyPath/Referance> content olani al tirnak icine yapistir
        ...
        Files.lines(Paths.get("src/haaluk.txt")).
